...
const nop = <T extends OP>(type: T, ty: string, params: { [name: string] : Paramable} = {}, actions: PulseAction[] = [], unique: string = null, text: string = null) => op(type)(ty, params, actions, unique, text)

export const top = (ty: string, params: { [name: string] : Paramable} = {}, actions: PulseAction[] = [], unique: string = null, text: string = null) => op<"TOP">("TOP")(ty, params, actions, unique, text)
export const tope = (optype: string) => op<"TOP">("TOP")(optype, {})
export const dat = (ty: string, params: { [name: string] : Paramable} = {}, actions: PulseAction[] = [], unique: string = null, text: string = null) => op<"DAT">("DAT")(ty, params, actions, unique, text)
export const date = (optype: string) => op<"DAT">("DAT")(optype, {})
export const chop = (ty: string, params: { [name: string] : Paramable} = {}, actions: PulseAction[] = [], unique: string = null, text: string = null) => nop("CHOP", ty, params, actions, unique, text)
export const chope = (optype: string) => op<"CHOP">("CHOP")(optype, {})
export const sop = (ty: string, params: { [name: string] : Paramable} = {}, actions: PulseAction[] = [], unique: string = null, text: string = null) => nop("SOP", ty, params, actions, unique, text)
export const sope = (optype: string) => op<"SOP">("SOP")(optype, {})
export const mat = (ty: string, params: { [name: string] : Paramable} = {}, actions: PulseAction[] = [], unique: string = null, text: string = null) => nop("MAT", ty, params, actions, unique, text)
export const mate = (optype: string) => op<"MAT">("MAT")(optype, {})
export const comp = (ty: string, params: { [name: string] : Paramable} = {}, actions: PulseAction[] = [], unique: string = null, text: string = null) => nop("COMP", ty, params, actions, unique, text)
